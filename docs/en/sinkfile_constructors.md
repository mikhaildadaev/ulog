...
::: info **Info**
This page documents `SinkFile`, which provides non-blocking atomic file rotation with `gzip` compression. Your service never blocks during log rotation or compression.
:::
