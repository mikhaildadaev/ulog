...
::: info **Информация**
На этой странице описаны готовые к использованию фабрики для `Discord`, `Kafka`, `Loki`, `Prometheus`, `Slack`, `Telegram`, `Tempo`, `WeChat`. Каждая фабрика — это предварительно настроенный `SinkHttp` с правильным форматером, заголовками и фильтрами.
:::
