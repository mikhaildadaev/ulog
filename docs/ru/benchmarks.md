...
::: tip Примечание
Включают в себя все дополнительные функции: форматирование в формате JSON, извлечение контекста, ввод-вывод файлов и проверку неблокирующей ротации. `Single Sync` - рекомендуемая рабочая конфигурация.
:::
