...
# API / Запись по сети / Конструкторы

::: info **Информация**
На этой странице описан `SinkHttp` — готовый к промышленной эксплуатации HTTP-приёмник с пакетной обработкой, Circuit Breaker, дедупликацией, повторными попытками и семплированием. Ваш сервис никогда не блокируется во время сетевой доставки.
:::
