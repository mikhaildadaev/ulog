...
# API / Запись в файл / Конструкторы

::: info **Информация**
На этой странице описан `SinkFile` — приёмник с неблокирующей атомарной ротацией файлов и сжатием `gzip`. Ваш сервис никогда не блокируется во время ротации или сжатия логов.
:::
